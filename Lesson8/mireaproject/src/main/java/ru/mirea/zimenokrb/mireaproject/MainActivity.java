package ru.mirea.zimenokrb.mireaproject;
...
import ru.mirea.zimenokrb.mireaproject.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ru.mirea.zimenokrb.mireaproject.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
        ...
        //Добавление маркера 1 на карту и обработка нажатия
        ...
        marker.setIcon(ResourcesCompat.getDrawable(getResources(), org.osmdroid.library.
                R.drawable.osm_ic_follow_me, null));
        ...
        //Добавление маркера 3 на карту и обработка нажатия
        Marker marker3 = new Marker(mapView);
        marker3.setPosition(new GeoPoint(55.765974, 37.644818));
        marker3.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Дворец бракосочетаний №1, Малый Харитоньевский переулок, 10с1",
                        Toast.LENGTH_LONG).show();
                return true;
            }
        });
        mapView.getOverlays().add(marker3);
        marker3.setIcon(ResourcesCompat.getDrawable(getResources(), org.osmdroid.library.
                R.drawable.osm_ic_follow_me, null));
